    ...
    <>
          ...
          {currentEpisode ? (
            <>
              ...
              <div className="px-4 py-3">
                <h3 className="text-[22px] font-semibold truncate">{currentEpisode.title}</h3>
      ...
      {currentEpisode && (
        ...
        >
          ...
          >
            {isExpanded ? (
              <ChevronDown className="w-12 h-12 rounded-full p-3 cursor-pointer transition" />
            ) : (
              <ChevronUp className="w-12 h-12 rounded-full p-3 cursor-pointer transition" />
            )}
          </button>
          ...
          {!isExpanded ? (
            <div className="flex items-center justify-between h-full">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/60">{currentEpisode.podcastTitle}</p>
                </div>
              </div>
            ...
            <div className="flex flex-col items-center justify-center mt-8 gap-6">
              ...
              <h3 className="text-lg font-semibold text-center">{currentEpisode.title}</h3>
              <p className="text-sm text-white/70 mb-2">{currentEpisode.podcastTitle}</p>
